...
//             Casos activos,Casos nuevos sin sintomas,Casos nuevos totales
          ...
          { text: 'Casos activos', value: 'Casos activos', filterable: false},
          { text: 'Fallecidos', value: 'Fallecidos' ,filterable: false},
          { text: 'Casos nuevos con sintomas', value: 'Casos nuevos con sintomas',filterable: false},
          { text: 'Casos nuevos sin sintomas', value: 'Casos nuevos sin sintomas', filterable: false},
          { text: 'Casos nuevos totales', value: 'Casos nuevos totales', filterable: false},
